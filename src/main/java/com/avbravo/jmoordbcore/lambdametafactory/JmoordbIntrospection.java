 ...
 */
package com.avbravo.jmoordbcore.lambdametafactory;


import com.avbravo.jmoordbcore.annotations.Repository;
import com.avbravo.jmoordbcore.util.Util;
...
public class JmoordbIntrospection {
   ...
   public  String nameOfEntity( Object entity) {
       String nameOfEntity ="";
        try {

            Object entitynew = entity.getClass().newInstance();
          nameOfEntity = util.nameOfEntity(entity.getClass().getName());
            nameOfEntity = util.letterToLower(nameOfEntity);
...
// </editor-fold>
     ...
     * @return 
     */
    public Object newEntity(Object entity){
        Object entitynew = entity;
        try {
          entitynew = entity.getClass().newInstance();
        } catch (Exception e) {

              LOG.log(Level.SEVERE, "newEntity() "+e.getLocalizedMessage());
